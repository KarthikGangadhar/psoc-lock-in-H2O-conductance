...
// ButtonSw32_v0_0(button_events=1, input_mode=0, input_width=1, state_check=0, timer_isr=0, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=ButtonSw32_v0_0, CY_CONFIG_TITLE=Button_1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Button_1, CY_INSTANCE_SHORT_NAME=Button_1, CY_MAJOR_VERSION=0, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Button_1, )
module ButtonSw32_v0_0_0 (
    clk,
    inp);
    input       clk;
    inout      [31:0] inp;
	...
	wire [0:0] tmpOE__REG_0_net;
	wire [0:0] tmpFB_0__REG_0_net;
	wire [0:0] tmpIO_0__REG_0_net;
	wire [0:0] tmpINTERRUPT_0__REG_0_net;
	electrical [0:0] tmpSIOVREF__REG_0_net;

	cy_psoc3_pins_v1_10
		#(.id("0201ccc7-f0f7-4013-9dfe-52ed22df70aa/8667df3d-7620-4d51-a04d-bbc4de6a8780"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		REG_0
		 (.oe(tmpOE__REG_0_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__REG_0_net[0:0]}),
		  .io({tmpIO_0__REG_0_net[0:0]}),
		  .siovref(tmpSIOVREF__REG_0_net),
		  .interrupt({tmpINTERRUPT_0__REG_0_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__REG_0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
...
module ADC_DelSig_v3_20_1 (
	...
	cy_psoc3_pins_v1_10
		#(.id("0a9ad3e9-8b12-488a-814f-468d9a54eb7f/93327f79-f616-44c2-ae10-d5db5cc52542"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
// UART_v2_50(Address1=0, Address2=0, BaudRate=9600, BreakBitsRX=13, BreakBitsTX=13, BreakDetect=false, CRCoutputsEn=false, Enable_RX=0, Enable_RXIntInterrupt=0, Enable_TX=1, Enable_TXIntInterrupt=1, EnableHWAddress=0, EnIntRXInterrupt=false, EnIntTXInterrupt=true, FlowControl=0, HalfDuplexEn=false, HwTXEnSignal=true, InternalClock=false, InternalClockToleranceMinus=3.93736842105263, InternalClockTolerancePlus=3.93736842105263, InternalClockUsed=0, InterruptOnAddDetect=0, InterruptOnAddressMatch=0, InterruptOnBreak=0, InterruptOnByteRcvd=0, InterruptOnOverrunError=0, InterruptOnParityError=0, InterruptOnStopError=0, InterruptOnTXComplete=false, InterruptOnTXFifoEmpty=true, InterruptOnTXFifoFull=false, InterruptOnTXFifoNotFull=false, IntOnAddressDetect=false, IntOnAddressMatch=false, IntOnBreak=false, IntOnByteRcvd=false, IntOnOverrunError=false, IntOnParityError=false, IntOnStopError=false, NumDataBits=8, NumStopBits=1, OverSamplingRate=8, ParityType=0, ParityTypeSw=false, RequiredClock=76800, RXAddressMode=0, RXBufferSize=4, RxBuffRegSizeReplacementString=uint8, RXEnable=false, TXBitClkGenDP=true, TXBufferSize=40, TxBuffRegSizeReplacementString=uint8, TXEnable=true, Use23Polling=true, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=UART_v2_50, CY_CONFIG_TITLE=UART_1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=UART_1, CY_INSTANCE_SHORT_NAME=UART_1, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=50, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=UART_1, )
module UART_v2_50_2 (
    cts_n,
    tx,
    rts_n,
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("211a73fa-fd17-4367-9622-e5e39a3f7641"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    cy_annotation_universal_v1_0 VRef_2 (
        .connect({
            Net_292
        })
    );
    defparam VRef_2.comp_name = "VRef_sm1_v1_0";
    defparam VRef_2.port_names = "T1";
    defparam VRef_2.width = 1;
    ...
    defparam SW_2.comp_name = "Button_sw_wide_v0_0";
    ...
    ButtonSw32_v0_0_0 Button_1 (
        .clk(Net_15947),
        .inp(Net_16198));

    cy_annotation_universal_v1_0 PB_4 (
        .connect({
            Net_235
        })
    );
    defparam PB_4.comp_name = "Break_sm1_v1_0";
    defparam PB_4.port_names = "Terminal_1";
    defparam PB_4.width = 1;

    cy_annotation_universal_v1_0 PB_3 (
        .connect({
            Net_236
        })
    );
    defparam PB_3.comp_name = "Break_sm1_v1_0";
    defparam PB_3.port_names = "Terminal_1";
    defparam PB_3.width = 1;
    ...
    cy_annotation_universal_v1_0 PB_2 (
        .connect({
            mod_n
        })
    );
    defparam PB_2.comp_name = "Break_sm1_v1_0";
    defparam PB_2.port_names = "Terminal_1";
    defparam PB_2.width = 1;

	wire [0:0] tmpOE__Pin_34_net;
	wire [0:0] tmpFB_0__Pin_34_net;
	wire [0:0] tmpIO_0__Pin_34_net;
	wire [0:0] tmpINTERRUPT_0__Pin_34_net;
	electrical [0:0] tmpSIOVREF__Pin_34_net;

	cy_psoc3_pins_v1_10
		#(.id("165ef903-bbf7-4b54-ad1e-ef1a02a03b3d"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_34
		 (.oe(tmpOE__Pin_34_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_34_net[0:0]}),
		  .analog({Net_97}),
		  .io({tmpIO_0__Pin_34_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_34_net),
		  .interrupt({tmpINTERRUPT_0__Pin_34_net[0:0]}),
		  .annotation({Net_235}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_34_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("8d25ec92-6af0-45f9-a532-b78b5c6cde25"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Pin_Tx_net;
	wire [0:0] tmpFB_0__Pin_Tx_net;
	wire [0:0] tmpIO_0__Pin_Tx_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Tx_net;
	electrical [0:0] tmpSIOVREF__Pin_Tx_net;

	cy_psoc3_pins_v1_10
		#(.id("ab219540-e7e7-40a2-b303-6e190edf1bff"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Tx
		 (.oe(tmpOE__Pin_Tx_net),
		  .y({Net_99}),
		  .fb({tmpFB_0__Pin_Tx_net[0:0]}),
		  .io({tmpIO_0__Pin_Tx_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Tx_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Tx_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Tx_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    defparam DelSig_1.comp_name = "DelSig_sm1_v1_0";
    defparam DelSig_1.port_names = "T2_1, T2_3, T2_4";
    defparam DelSig_1.width = 3;
	...
	wire [0:0] tmpOE__Pin_152_net;
	wire [0:0] tmpFB_0__Pin_152_net;
	wire [0:0] tmpIO_0__Pin_152_net;
	wire [0:0] tmpINTERRUPT_0__Pin_152_net;
	electrical [0:0] tmpSIOVREF__Pin_152_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_152
		 (.oe(tmpOE__Pin_152_net),
		  .y({mod1}),
		  .fb({tmpFB_0__Pin_152_net[0:0]}),
		  .io({tmpIO_0__Pin_152_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_152_net),
		  .interrupt({tmpINTERRUPT_0__Pin_152_net[0:0]}),
		  .annotation({mod_p}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_152_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


    assign Net_128 = ~mod1;

	wire [0:0] tmpOE__Pin_153_net;
	wire [0:0] tmpFB_0__Pin_153_net;
	wire [0:0] tmpIO_0__Pin_153_net;
	wire [0:0] tmpINTERRUPT_0__Pin_153_net;
	electrical [0:0] tmpSIOVREF__Pin_153_net;

	cy_psoc3_pins_v1_10
		#(.id("985e26af-53d7-4a21-b9bb-5924de3fa5d0"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_153
		 (.oe(tmpOE__Pin_153_net),
		  .y({Net_128}),
		  .fb({tmpFB_0__Pin_153_net[0:0]}),
		  .io({tmpIO_0__Pin_153_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_153_net),
		  .interrupt({tmpINTERRUPT_0__Pin_153_net[0:0]}),
		  .annotation({mod_n}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_153_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    cy_annotation_universal_v1_0 PB_1 (
        .connect({
            mod_p
        })
    );
    defparam PB_1.comp_name = "Break_sm1_v1_0";
    defparam PB_1.port_names = "Terminal_1";
    defparam PB_1.width = 1;
    ...
    defparam SerialPlot_1.port_names = "RX_1, RX_2, Rx1_1_1, Rx1_1_0, Rx1_2_1, Rx1_2_0, TX_1, TX_2";
    defparam SerialPlot_1.width = 8;
    ...
    defparam SW_1.comp_name = "Button_sw_wide_v0_0";
    ...
    defparam P_1.port_names = "P_120, P_121, P_122, P_123, P_124, P_125, P_126, P_127";
    defparam P_1.width = 8;
